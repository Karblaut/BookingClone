...
export const icons = [
  ...
  { icon: faCar, name: "Car rentals", spanText: "Pick-up and drop-off" },
  { icon: faPerson, name: "Attractions", spanText: "2 adults person" },
  { icon: faPlane, name: "Airport taxis", spanText: "Airport transfers" },
];
